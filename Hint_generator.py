...
"East Castle Town Bridge Poe": "Lanayru Fields (West & North Hyrule Fields)",
...
"Faron Field Bridge Chest": "Faron Fields (South Hyrule Fields)",
"Faron Field Corner Grotto Left Chest": "Faron Fields (South Hyrule Fields)",
"Faron Field Corner Grotto Rear Chest": "Faron Fields (South Hyrule Fields)",
"Faron Field Corner Grotto Right Chest": "Faron Fields (South Hyrule Fields)",
"Faron Field Female Beetle": "Faron Fields (South Hyrule Fields)",
"Faron Field Male Beetle": "Faron Fields (South Hyrule Fields)",
"Faron Field Poe": "Faron Fields (South Hyrule Fields)",
"Faron Field Tree Heart Piece": "Faron Fields (South Hyrule Fields)",
...
"Hyrule Field Ampitheater Owl Statue Chest": "Lanayru Fields (West & North Hyrule Fields)",
"Hyrule Field Ampitheater Owl Statue Sky Character": "Lanayru Fields (West & North Hyrule Fields)",
"Hyrule Field Ampitheater Poe": "Lanayru Fields (West & North Hyrule Fields)",
...
"Lanayru Field Behind Gate Underwater Chest": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Field Bridge Poe": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Field Female Stag Beetle": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Field Male Stag Beetle": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Field Poe Grotto Left Poe": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Field Poe Grotto Right Poe": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Field Skulltula Grotto Chest": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Field Spinner Track Chest": "Lanayru Fields (West & North Hyrule Fields)",
"Lanayru Ice Block Puzzle Cave Chest": "Lanayru Fields (West & North Hyrule Fields)",
...
"West Hyrule Field Female Butterfly": "Lanayru Fields (West & North Hyrule Fields)",
"West Hyrule Field Golden Wolf": "Lanayru Fields (West & North Hyrule Fields)",
"West Hyrule Field Helmasaur Grotto Chest": "Lanayru Fields (West & North Hyrule Fields)",
"West Hyrule Field Male Butterfly": "Lanayru Fields (West & North Hyrule Fields)",
...
# Analyse Sometimes checks
for check, item in data["itemPlacements"].items():
    if check in sometimes_checks:
        sometimes_items[check] = item

# Select 3 Sometimes checks
sometimes_random = random.sample(list(sometimes_items.items()), k=3)
sometimes_random = list(set(sometimes_random))

# Add Sometimes to the xlsx file
for i, entry in enumerate(sometimes_random, start=18):
    check, item = entry
    worksheet.cell(row=i, column=2, value=f'{check} : {item}')

# Prompt Sometimes
for check_item in sometimes_random:
